...
* using historic factor requirements and capital shares up to 2010
if (m_year(t)<2010,
$ifthen "%c38_sticky_mode%" == "dynamic" p38_capital_cost_share(t,i) = f38_historical_share(t,i);
$endif
p38_variable_costs(t,i,kcr) = f38_fac_req_regional(t,i,kcr)  * (1-p38_capital_cost_share(t,i));
p38_capital_need(t,i,kcr,"mobile") = f38_fac_req_regional(t,i,kcr) * p38_capital_cost_share(t,i) / (pm_interest(t,i)+s38_depreciation_rate) * (1-s38_immobile);
p38_capital_need(t,i,kcr,"immobile") = f38_fac_req_regional(t,i,kcr)  * p38_capital_cost_share(t,i) / (pm_interest(t,i)+s38_depreciation_rate) * s38_immobile;
