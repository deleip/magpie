...
$Ifi "%phase%" == "sets" $include "./modules/38_factor_costs/sticky_regional/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/38_factor_costs/sticky_regional/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/38_factor_costs/sticky_regional/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/38_factor_costs/sticky_regional/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/38_factor_costs/sticky_regional/scaling.gms"
$Ifi "%phase%" == "presolve" $include "./modules/38_factor_costs/sticky_regional/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/38_factor_costs/sticky_regional/postsolve.gms"
